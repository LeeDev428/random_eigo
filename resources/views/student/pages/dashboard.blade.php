...
@section('content')
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $dashboardStats['lessons_completed'] }}</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $dashboardStats['credits_remaining'] }}</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $dashboardStats['certificates_earned'] }}</div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $dashboardStats['current_level'] }}</div>
